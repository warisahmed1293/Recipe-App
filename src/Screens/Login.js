    ...
    return (
        <>
            <View style={{ marginLeft: 40, marginTop: 50 }}>
                <Text style={{ fontSize: 35, fontWeight: '800', color: 'black', letterSpacing: 2 }}>Hello,</Text>
                <Text style={{ fontSize: 25, color: 'black', fontWeight: '300', marginVertical: 5, letterSpacing: 2 }}>Welcome Back!</Text>
            </View>
